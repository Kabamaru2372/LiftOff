...
struct WhatsNewView: View {
    ...
    private var items: [Item] {
        [
            ...
            Item(emoji: "🎯",
                 title: t("Exact pickup counting", "Ακριβής μέτρηση σηκωμάτων", "Exakte Griff-Zählung"),
                 body: t("Optional precise counts — even when Picksy is closed.",
                         "Προαιρετικά ακριβή νούμερα — ακόμα κι όταν το Picksy είναι κλειστό.",
                         "Optional genaue Zahlen — auch wenn Picksy geschlossen ist.")),
            Item(emoji: "👨‍👩‍👧",
